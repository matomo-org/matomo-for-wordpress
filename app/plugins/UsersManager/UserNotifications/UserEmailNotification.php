...
abstract class UserEmailNotification extends \Piwik\Plugins\UsersManager\UserNotifications\UserNotification
{
    /**
     ...
     */
    public function __construct(array $users, array $recipients, array $emailData = [])
    {
