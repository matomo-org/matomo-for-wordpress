...
class API extends \Piwik\Plugin\API
{
    ...
    private function toDataTable(array $metrics)
    {
        ...
        foreach ($metrics as $metric) {
            ...
            $translated[$label] = ['id' => $metric->getId(), 'rank' => $metric->getValue(), 'logo' => $metric->getLogo(), 'logo_link' => $metric->getLogoLink(), 'logo_tooltip' => Piwik::translate($metric->getLogoTooltip()), 'rank_suffix' => Piwik::translate($metric->getValueSuffix())];
        }
