...
class Bing implements \Piwik\Plugins\SEO\Metric\MetricsProvider
{
    ...
    public function getMetrics($domain)
    {
        ...
        try {
            ...
            // number uses nbsp as thousand separator
        ...
        return array(new \Piwik\Plugins\SEO\Metric\Metric('bing-index', 'SEO_Bing_IndexedPages', $pageCount, $logo, null, null, $suffix));
    }
}
