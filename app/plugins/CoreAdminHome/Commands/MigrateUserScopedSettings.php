...
class MigrateUserScopedSettings extends ConsoleCommand
{
    protected function configure()
    {
        ...
        $this->setDescription('Only needed for Matomo 5.9.0-b1 upgrade. ' . 'Migrates legacy user-scoped settings from option keys to plugin_setting rows and purges legacy option keys.');
    }
