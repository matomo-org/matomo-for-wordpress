...
{
    protected $dimensions = [Archiver::COUNTRY_RECORD_NAME => Archiver::COUNTRY_FIELD, Archiver::REGION_RECORD_NAME => Archiver::REGION_FIELD, Archiver::CITY_RECORD_NAME => Archiver::CITY_FIELD];
    ...
    public function getRecordMetadata(ArchiveProcessor $archiveProcessor) : array
    {
        ...
        return [Record::make(Record::TYPE_BLOB, Archiver::COUNTRY_RECORD_NAME), Record::make(Record::TYPE_BLOB, Archiver::REGION_RECORD_NAME)->setMaxRowsInTable($maxRowsInTable), Record::make(Record::TYPE_BLOB, Archiver::CITY_RECORD_NAME)->setMaxRowsInTable($maxRowsInTable), Record::make(Record::TYPE_NUMERIC, Archiver::DISTINCT_COUNTRIES_METRIC)->setIsCountOfBlobRecordRows(Archiver::COUNTRY_RECORD_NAME)];
    }
    ...
    {
        if (!empty($row[Archiver::CITY_FIELD]) && !empty($row[Archiver::LATITUDE_FIELD]) && !empty($row[Archiver::LONGITUDE_FIELD]) && empty($this->latLongForCities[$row[Archiver::CITY_FIELD]])) {
