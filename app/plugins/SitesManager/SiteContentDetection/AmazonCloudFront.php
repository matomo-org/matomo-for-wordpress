...
class AmazonCloudFront extends \Piwik\Plugins\SitesManager\SiteContentDetection\SiteContentDetectionAbstract
{
    ...
    public function isDetected(?string $data = null, ?array $headers = null) : bool
    {
        ...
        return $this->headerContains($headers, 'server', 'cloudfront') || $this->headerContains($headers, 'via', 'cloudfront') || $this->headerContains($headers, 'x-cache', 'cloudfront') || $this->headerExists($headers, 'x-amz-cf-id') || $this->headerExists($headers, 'x-amz-cf-pop');
    }
    /**
