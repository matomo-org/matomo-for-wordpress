...
class EventReports extends RecordBuilder
{
    public function __construct()
    {
        ...
        $this->columnAggregationOps = [Metrics::INDEX_EVENT_MIN_EVENT_VALUE => 'min', Metrics::INDEX_EVENT_MAX_EVENT_VALUE => 'max'];
    }
    ...
    {
        return [Archiver::EVENTS_CATEGORY_ACTION_RECORD_NAME => ["eventCategory", "eventAction"], Archiver::EVENTS_CATEGORY_NAME_RECORD_NAME => ["eventCategory", "eventName"], Archiver::EVENTS_ACTION_NAME_RECORD_NAME => ["eventAction", "eventName"], Archiver::EVENTS_ACTION_CATEGORY_RECORD_NAME => ["eventAction", "eventCategory"], Archiver::EVENTS_NAME_ACTION_RECORD_NAME => ["eventName", "eventAction"], Archiver::EVENTS_NAME_CATEGORY_RECORD_NAME => ["eventName", "eventCategory"]];
    }
    protected function aggregate(ArchiveProcessor $archiveProcessor) : array
    {
        ...
        $from = ["log_link_visit_action", ["table" => "log_action", "tableAlias" => "log_action_event_category", "joinOn" => "log_link_visit_action.idaction_event_category = log_action_event_category.idaction"], ["table" => "log_action", "tableAlias" => "log_action_event_action", "joinOn" => "log_link_visit_action.idaction_event_action = log_action_event_action.idaction"], ["table" => "log_action", "tableAlias" => "log_action_event_name", "joinOn" => "log_link_visit_action.idaction_name = log_action_event_name.idaction"]];
