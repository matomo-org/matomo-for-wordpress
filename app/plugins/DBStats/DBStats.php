...
class DBStats extends \Piwik\Plugin
{
    ...
    {
        return array('Translate.getClientSideTranslationKeys' => 'getClientSideTranslationKeys', "TestingEnvironment.addHooks" => 'setupTestEnvironment', 'AssetManager.getStylesheetFiles' => 'getStylesheetFiles');
    }
