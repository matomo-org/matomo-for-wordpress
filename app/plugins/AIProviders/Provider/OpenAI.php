...
class OpenAI extends \Piwik\Plugins\AIProviders\Provider\AIProvider
{
    ...
    {
        return $this->completeChatCompletion($request, $this->getEndpointUrl($configuration), ['Authorization' => 'Bearer ' . $this->getApiKey($configuration)]);
    }
    /**
    ...
    {
        $this->sendGetRequest($this->openAiCompatibleModelsEndpoint($this->getEndpointUrl($configuration)), ['Authorization' => 'Bearer ' . $this->getApiKey($configuration)]);
    }
    ...
    {
        return $this->converseChatCompletion($request, $this->getEndpointUrl($configuration), ['Authorization' => 'Bearer ' . $this->getApiKey($configuration)]);
    }
}
