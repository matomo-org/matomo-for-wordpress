...
class ScheduledReports extends \Piwik\Plugin
{
    ...
    private static $availableParameters = array(self::EMAIL_ME_PARAMETER => \false, self::EVOLUTION_GRAPH_PARAMETER => \false, self::ADDITIONAL_EMAILS_PARAMETER => \false, self::DISPLAY_FORMAT_PARAMETER => \true, self::ENFORCE_ORDER_PARAMETER => \false, self::REPORT_DESCRIPTION_PARAMETER => \false);
