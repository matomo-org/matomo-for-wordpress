...
class AIAgentName extends VisitDimension
{
    ...
    public function shouldForceNewVisit(Request $request, Visitor $visitor, ?Action $action = null)
    {
        ...
        if ($provider !== $previousProvider) {
            StaticContainer::get(LoggerInterface::class)->debug('Existing visit detected, but creating new visit because AI agent information is different than last action.');
            return \true;
        }
        return \false;
    }
