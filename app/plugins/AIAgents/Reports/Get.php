...
class Get extends Report
{
    ...
    {
        $widgetsList->addWidgetConfig($factory->createWidget()->setName('AIAgents_WidgetGraphAIAgents')->forceViewDataTable(Evolution::ID)->setAction('getEvolutionGraph')->setOrder(1));
        $widgetsList->addWidgetConfig($factory->createWidget()->forceViewDataTable(Sparklines::ID)->setName('AIAgents_WidgetOverviewAIAgents')->setOrder(2));
    }
    ...
    {
        return ['avg_time_on_site_ai_agent' => Piwik::translate('AIAgents_SparklineAIAgentAverageVisitDuration'), 'avg_time_on_site_human' => Piwik::translate('AIAgents_SparklineHumanAverageVisitDuration'), 'bounce_rate_ai_agent' => Piwik::translate('AIAgents_SparklineAIAgentBounceRate'), 'bounce_rate_human' => Piwik::translate('AIAgents_SparklineHumanBounceRate'), 'nb_actions_ai_agent' => Piwik::translate('AIAgents_SparklineAIAgentActions'), 'nb_actions_human' => Piwik::translate('AIAgents_SparklineHumanActions'), 'nb_actions_per_visit_ai_agent' => Piwik::translate('AIAgents_SparklineAIAgentAvgActionsPerVisit'), 'nb_actions_per_visit_human' => Piwik::translate('AIAgents_SparklineHumanAvgActionsPerVisit'), 'nb_visits_ai_agent' => Piwik::translate('AIAgents_SparklineAIAgentVisits'), 'nb_visits_human' => Piwik::translate('AIAgents_SparklineHumanVisits')];
    }
    private function addSparklineColumns(Sparklines $view) : void
    {
        $metrics = ['nb_visits', 'avg_time_on_site', 'nb_actions_per_visit', 'bounce_rate', 'nb_actions'];
        $i = 1;
