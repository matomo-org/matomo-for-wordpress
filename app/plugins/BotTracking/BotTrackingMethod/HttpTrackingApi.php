...
use Piwik\Piwik;
use Piwik\Url;
class HttpTrackingApi extends \Piwik\Plugins\BotTracking\BotTrackingMethod\BotTrackingMethodAbstract
{
    ...
    public static function renderInstructionsTab() : string
    {
        ...
        $description = Piwik::translate('BotTracking_NoDataHttpTrackingApiDescription', [$knowledgeBaseLink, '</a>', $referenceLink, '</a>']);
