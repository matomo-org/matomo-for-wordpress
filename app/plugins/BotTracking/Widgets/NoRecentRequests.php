...
class NoRecentRequests extends Widget
{
    ...
    {
        $config->setName('BotTracking_NoRecentRequestsWidgetTitle')->setCategoryId('General_AIAssistants')->setSubcategoryId($subcategoryId)->setModule('BotTracking')->setAction($action)->setClientSideComponent('BotTracking', 'NoRecentRequestsWidget')->setMiddlewareParameters(['module' => 'BotTracking', 'action' => 'showNoRecentRequestsMessage'])->setIsWide()->setOrder(0)->setIsNotWidgetizable();
    }
}
