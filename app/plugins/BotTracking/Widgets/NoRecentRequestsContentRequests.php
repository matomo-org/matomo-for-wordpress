...
class NoRecentRequestsContentRequests extends Widget
{
    ...
    {
        \Piwik\Plugins\BotTracking\Widgets\NoRecentRequests::configureMessageWidget($config, 'BotTracking_AIChatbotsContentRequests', 'noRecentRequestsMessageContentRequests');
    }
}
