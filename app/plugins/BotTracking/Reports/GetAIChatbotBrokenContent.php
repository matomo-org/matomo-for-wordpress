...
class GetAIChatbotBrokenContent extends Report
{
    ...
    public function configureView(ViewDataTable $view) : void
    {
        ...
        $view->config->setDefaultColumnsToDisplay(['label', Metrics::COLUMN_TOTAL_BROKEN_REQUESTS, Metrics::COLUMN_PAGE_NOT_FOUND_404_REQUESTS, Metrics::COLUMN_SERVER_ERROR_5XX_REQUESTS], \false, \false);
