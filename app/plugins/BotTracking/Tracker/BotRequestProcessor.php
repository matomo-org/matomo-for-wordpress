...
class BotRequestProcessor extends \Piwik\Tracker\BotRequestProcessor
{
    ...
    public function handleRequest(Request $request) : bool
    {
        ...
        try {
            ...
            $data = ['idsite' => $idSite, 'server_time' => $serverTime, 'idaction_url' => $idActionUrl, 'bot_name' => $botInfo['bot_name'], 'bot_type' => $botInfo['bot_type'], 'http_status_code' => $httpStatusCode, 'response_size_bytes' => $responseSizeBytes, 'response_time_ms' => $serverTimeMs, 'source' => $source];
