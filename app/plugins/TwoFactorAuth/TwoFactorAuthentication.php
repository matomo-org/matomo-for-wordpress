...
class TwoFactorAuthentication
{
    ...
    public function __construct(\Piwik\Plugins\TwoFactorAuth\SystemSettings $systemSettings, RecoveryCodeDao $recoveryCodeDao, TwoFaSecretRandomGenerator $twoFaSecretRandomGenerator)
    {
    ...
    public function saveSecret($login, #[\SensitiveParameter] $secret)
    {
    ...
    private function wasTwoFaCodeUsedRecently($login, #[\SensitiveParameter] $authCode)
    {
    ...
    private function gettwoFaCodeUsedKey($login, #[\SensitiveParameter] $authCode)
    {
        return self::OPTION_PREFIX_TWO_FA_CODE_USED . md5($login . $authCode . SettingsPiwik::getSalt());
    }
    private function setTwoFaCodeWasUsed($login, #[\SensitiveParameter] $authCode)
    {
    ...
    public function validateAuthCode($login, #[\SensitiveParameter] $authCode)
    {
    ...
    public function validateAuthCodeDuringSetup(#[\SensitiveParameter] $authCode, #[\SensitiveParameter] $secret)
    {
