...
class AnalyzeArchiveTable extends ConsoleCommand
{
    protected function configure()
    {
        ...
        $this->setDescription('Analyze an archive table and display human readable information about what is stored. ' . 'This command can be used to diagnose issues like bloated archive tables.');
    ...
    protected function doExecute() : int
    {
        ...
        $headers = array('Group', '# Archives', '# Invalidated', '# Temporary', '# Error', '# Segment', '# Numeric Rows', '# Blob Rows', '# Blob Data');
        // display all rows
