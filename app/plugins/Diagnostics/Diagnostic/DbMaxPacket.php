 ...
 */
class DbMaxPacket implements \Piwik\Plugins\Diagnostics\Diagnostic\Diagnostic
{
    /**
     * @var Translator
     */
    ...
    public function execute()
    {
        if (!SettingsPiwik::isMatomoInstalled()) {
            return array();
            // only possible to perform check once we have DB connection
        }
        ...
        // not using 1024 just in case... this amount be good enough
