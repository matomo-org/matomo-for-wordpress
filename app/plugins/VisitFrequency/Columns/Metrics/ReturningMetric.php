...
{
    private static $translations = array('avg_time_on_site_returning' => 'VisitFrequency_ColumnAverageVisitDurationForReturningVisitors', 'avg_time_on_site_new' => 'VisitFrequency_ColumnAverageVisitDurationForNewVisitors', 'nb_actions_per_visit_returning' => 'VisitFrequency_ColumnAvgActionsPerReturningVisit', 'nb_actions_per_visit_new' => 'VisitFrequency_ColumnAvgActionsPerNewVisit', 'bounce_rate_returning' => 'VisitFrequency_ColumnBounceRateForReturningVisits', 'bounce_rate_new' => 'VisitFrequency_ColumnBounceRateForNewVisits', 'nb_users_returning' => 'VisitFrequency_ColumnReturningUsers', 'nb_users_new' => 'VisitFrequency_ColumnNewUsers');
    /**
     * @var ProcessedMetric
     */
    private $wrapped;
    ...
    {
        return 0;
        // (metric is not computed, it is copied from segmented report)
    }
