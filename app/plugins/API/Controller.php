...
class Controller extends \Piwik\Plugin\Controller
{
    ...
    public function glossary()
    {
        ...
        $glossaryItems = array('metrics' => array('title' => Piwik::translate('General_Metrics'), 'entries' => $metrics), 'reports' => array('title' => Piwik::translate('General_Reports'), 'entries' => $reports));
        /**
