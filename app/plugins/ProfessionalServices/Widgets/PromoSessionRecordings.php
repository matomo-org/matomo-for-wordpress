...
class PromoSessionRecordings extends \Piwik\Plugins\ProfessionalServices\Widgets\DismissibleWidget
{
    ...
    public function render()
    {
        ...
        $view->listOfFeatures = [Piwik::translate('ProfessionalServices_SessionRecordingsFeature01'), Piwik::translate('ProfessionalServices_SessionRecordingsFeature02'), Piwik::translate('ProfessionalServices_SessionRecordingsFeature03')];
        return $view->render();
    }
}
