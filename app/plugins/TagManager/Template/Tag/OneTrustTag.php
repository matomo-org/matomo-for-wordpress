...
class OneTrustTag extends \Piwik\Plugins\TagManager\Template\Tag\BaseTag
{
    ...
    {
        return array($this->makeSetting('domain', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
