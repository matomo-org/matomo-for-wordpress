...
class AxeptioTag extends \Piwik\Plugins\TagManager\Template\Tag\BaseTag
{
    ...
    {
        return array($this->makeSetting('projectId', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
