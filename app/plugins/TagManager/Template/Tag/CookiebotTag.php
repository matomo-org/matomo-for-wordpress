...
class CookiebotTag extends BaseTag
{
    ...
    public function getIcon()
    {
        ...
        return 'plugins/TagManager/images/icons/cookiebot.svg';
    }
    public function getParameters()
    {
        return array($this->makeSetting('cookiebotId', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
            $field->title = Piwik::translate('TagManager_CookiebotTagIdTitle');
            $field->description = Piwik::translate('TagManager_CookiebotTagIdDescription');
