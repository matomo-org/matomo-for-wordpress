...
/**
 */
class GenerateController extends \Piwik\Plugins\CoreConsole\Commands\GeneratePluginBase
{
    protected function configure()
    {
        $this->setName('generate:controller')->setDescription('Adds a Controller to an existing plugin')->addRequiredValueOption('pluginname', null, 'The name of an existing plugin which does not have a Controller yet');
    }
    protected function doExecute() : int
    {
        ...
        $this->writeSuccessMessage(array(sprintf('Controller for %s generated.', $pluginName), 'You can now start adding Controller actions', 'Enjoy!'));
        return self::SUCCESS;
    }
    /**
     * @return string
