...
class GenerateArchiver extends \Piwik\Plugins\CoreConsole\Commands\GeneratePluginBase
{
    ...
    {
        $this->setName('generate:archiver')->setDescription('Adds an Archiver to an existing plugin')->addRequiredValueOption('pluginname', null, 'The name of an existing plugin which does not have an Archiver yet');
    }
    protected function doExecute() : int
    {
        ...
        $this->writeSuccessMessage(array(sprintf('Archiver.php for %s generated.', $pluginName), 'You can now start implementing Archiver methods', 'Enjoy!'));
        return self::SUCCESS;
    }
    /**
     * @return string
