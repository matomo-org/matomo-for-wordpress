...
class Controller extends \Piwik\Plugin\Controller
{
    ...
    public function manageSegments() : string
    {
        ...
        $allVisitsSegment = ['definition' => '', 'name' => Piwik::translate('SegmentEditor_DefaultAllVisits'), 'fixed' => \true, 'starred' => \false];
        ...
        foreach ($view->segmentList as &$segment) {
            ...
            if ($this->isRealtimeSegment($segment)) {
                $segment['isRealtime'] = \true;
                $view->hasRealtimeSegments = \true;
                continue;
            }
    ...
    {
        $params = $this->getGraphParamsModified(['viewDataTable' => 'sparkline', 'action' => 'getEvolutionGraph', 'module' => 'VisitsSummary', 'columns' => ['nb_visits'], 'segment' => $segment['definition']]);
    ...
    {
        $translationKeys = array('SegmentEditor_AddNewSegment', 'SegmentEditor_ManageSegments', 'SegmentEditor_SegmentPageTitle', 'SegmentEditor_SegmentPageDescription', 'SegmentEditor_SeeDashboardForThisSegment', 'SegmentEditor_SparklineTooltipDays', 'SegmentEditor_SparklineTooltipWeeks', 'SegmentEditor_SparklineTooltipMonths', 'SegmentEditor_SparklineTooltipYears', 'SegmentEditor_ManageSegmentsRealtimeNotice', 'SegmentEditor_ManageSegmentsRealtimeNoDataTooltip', 'General_Segment', 'General_SegmentDocumentation', 'General_ColumnEvolutionVisits', 'General_ColumnEvolutionVisitsDocumentation', 'General_ColumnNbVisits', 'General_ColumnNbVisitsDocumentation', 'General_ColumnNbActions', 'General_ColumnNbActionsDocumentation', 'General_Search', 'General_SearchNoResults');
        $translations = array();
