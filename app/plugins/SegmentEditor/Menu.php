...
class Menu extends \Piwik\Plugin\Menu
{
    public function configureAdminMenu(MenuAdmin $menu)
    {
        ...
        if ($idSite !== -1) {
            $menu->addMeasurableItem('CoreHome_Segments', $this->urlForModuleAction('CoreHome', 'index', ['idSite' => $idSite, 'category' => 'General_Visitors', 'subcategory' => 'CoreHome_Segments']), 19, Piwik::translate('SegmentEditor_ManageSegments'), 'icon-outlink');
        }
    }
