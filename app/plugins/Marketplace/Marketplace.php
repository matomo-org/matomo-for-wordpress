...
class Marketplace extends \Piwik\Plugin
{
    ...
    {
        return array('AssetManager.getJavaScriptFiles' => 'getJsFiles', 'AssetManager.getStylesheetFiles' => 'getStylesheetFiles', 'Translate.getClientSideTranslationKeys' => 'getClientSideTranslationKeys', 'Controller.CoreHome.checkForUpdates' => 'checkForUpdates', 'Controller.CoreHome.markNotificationAsRead' => 'dismissPluginTrialNotification', 'Request.dispatch' => 'createPluginTrialNotification', 'PluginManager.pluginInstalled' => 'removePluginTrialRequest', 'PluginManager.pluginActivated' => 'removePluginTrialRequest', 'Widget.filterWidgets' => 'filterWidgets');
    }
