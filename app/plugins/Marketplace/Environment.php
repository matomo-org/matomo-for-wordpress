...
class Environment
{
    ...
    public function getUniqueId()
    {
        ...
        if (empty($uniqueId)) {
            $uniqueId = hash('sha256', Common::generateUniqId() . Common::getRandomString(40));
            Option::set(\Piwik\Plugins\Marketplace\Environment::OPTION_MARKETPLACE_UNIQUE_ID, $uniqueId);
        }
        return $uniqueId;
    }
