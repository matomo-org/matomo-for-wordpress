...
class Plugins
{
    ...
    public function __construct(\Piwik\Plugins\Marketplace\Api\Client $marketplaceClient, \Piwik\Plugins\Marketplace\Consumer $consumer, Advertising $advertising)
    {
    ...
    public function getLicenseValidInfo($pluginName)
    {
        ...
        return array('hasExceededLicense' => !empty($plugin['hasExceededLicense']), 'isMissingLicense' => !empty($plugin['isMissingLicense']));
    }
