...
class Client
{
     ...
     */
    private $environment;
    public function __construct(\Piwik\Plugins\Marketplace\Api\Service $service, Lazy $cache, LoggerInterface $logger, Environment $environment)
    {
    ...
    private function fetch($action, $params)
    {
        ...
        try {
            ...
            throw new \Piwik\Plugins\Marketplace\Api\Exception($e->getMessage(), $e->getCode());
        }
