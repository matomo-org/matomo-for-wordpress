...
class Get extends \Piwik\Plugin\Report
{
    ...
    protected function init()
    {
        ...
        $this->metrics = array('nb_visits', $this->usersColumn, 'nb_actions', 'max_actions');
