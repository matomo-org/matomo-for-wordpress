...
class API extends \Piwik\Plugin\API
{
    ...
    public function getResolution($idSite, string $period, string $date, $segment = \false)
    {
        ...
        $idSitesFiltered = array_filter($idSites, function ($idSite) {
            return !\Piwik\Plugins\Resolution\Resolution::isScreenResolutionDetectionDisabledByCompliancePolicy((int) $idSite);
        });
        ...
        $dataTable = $this->getDataTable(\Piwik\Plugins\Resolution\Archiver::RESOLUTION_RECORD_NAME, $idSitesFiltered, $period, $date, $segment);
