...
class VisitorLogSubcategory extends Subcategory
{
    ...
    public function getHelp()
    {
        ...
        $help .= '<p><a href="' . Url::addCampaignParametersToMatomoLink('https://matomo.org/docs/real-time/', null, null, 'App.Live.getLastVisitsDetails') . '" target="_blank" rel="noreferrer noopener">' . Piwik::translate('Live_VisitorLogSubcategoryHelp3') . '</a></p>';
        return $help;
    }
}
