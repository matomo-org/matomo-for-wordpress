...
class ForecastSeriesStateBuilder
{
     ...
     */
    public function addForecastSeries(string $seriesLabel, array $seriesData, array $seriesDataAvailability, string $monotonicity, int $forecastPrecision, string $columnName, $rowLabel) : void
    {
        $this->allSeriesData[$seriesLabel] = $seriesData;
    ...
    public function build() : \Piwik\Plugins\CoreVisualizations\JqplotDataGenerator\ForecastSeriesState
    {
        return new \Piwik\Plugins\CoreVisualizations\JqplotDataGenerator\ForecastSeriesState($this->allSeriesData, $this->allSeriesDataAvailability, $this->allSeriesMonotonicity, $this->allSeriesForecastPrecision, $this->allSeriesColumns, $this->allSeriesRows);
    }
}
