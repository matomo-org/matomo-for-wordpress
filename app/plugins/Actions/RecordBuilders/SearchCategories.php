...
class SearchCategories extends ArchiveProcessor\RecordBuilder
{
    protected function aggregate(ArchiveProcessor $archiveProcessor) : array
    {
        ...
        return [Archiver::SITE_SEARCH_CATEGORY_RECORD_NAME => $table];
    }
    public function getRecordMetadata(ArchiveProcessor $archiveProcessor) : array
    {
        return [Record::make(Record::TYPE_BLOB, Archiver::SITE_SEARCH_CATEGORY_RECORD_NAME)->setMaxRowsInTable(ArchivingHelper::$maximumRowsInDataTableSiteSearch)];
    }
