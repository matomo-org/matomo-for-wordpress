...
class ActionReports extends ArchiveProcessor\RecordBuilder
{
    public function __construct()
    {
        ...
        parent::__construct(ArchivingHelper::$maximumRowsInDataTableLevelZero, ArchivingHelper::$maximumRowsInSubDataTable, ArchivingHelper::$columnToSortByBeforeTruncation, null, Metrics::$columnsToRenameAfterAggregation);
    }
    public function getRecordMetadata(ArchiveProcessor $archiveProcessor) : array
    {
        $pageUrlsRecord = Record::make(Record::TYPE_BLOB, Archiver::PAGE_URLS_RECORD_NAME)->setBlobColumnAggregationOps(Metrics::getColumnsAggregationOperation());
        $pageTitlesRecord = Record::make(Record::TYPE_BLOB, Archiver::PAGE_TITLES_RECORD_NAME)->setBlobColumnAggregationOps(Metrics::getColumnsAggregationOperation());
        if ($this->isFlatArchivingEnabled()) {
            $this->setHierarchyBuiltFromFlatRecord($pageUrlsRecord, Archiver::PAGE_URLS_FLAT_RECORD_NAME, [$this, 'flatRowToUrlHierarchyPath'], [$this, 'reduceLegacyUrlHierarchyIntoFlatTable']);
            $this->setHierarchyBuiltFromFlatRecord($pageTitlesRecord, Archiver::PAGE_TITLES_FLAT_RECORD_NAME, [$this, 'flatRowToTitleHierarchyPath'], [$this, 'reduceLegacyTitleHierarchyIntoFlatTable']);
        }
        $records = [Record::make(Record::TYPE_BLOB, Archiver::SITE_SEARCH_RECORD_NAME)->setMaxRowsInTable(ArchivingHelper::$maximumRowsInDataTableSiteSearch), $pageUrlsRecord, $pageTitlesRecord, Record::make(Record::TYPE_BLOB, Archiver::DOWNLOADS_RECORD_NAME), Record::make(Record::TYPE_BLOB, Archiver::OUTLINKS_RECORD_NAME), Record::make(Record::TYPE_NUMERIC, Archiver::METRIC_SEARCHES_RECORD_NAME), Record::make(Record::TYPE_NUMERIC, Archiver::METRIC_KEYWORDS_RECORD_NAME)->setIsCountOfBlobRecordRows(Archiver::SITE_SEARCH_RECORD_NAME), Record::make(Record::TYPE_NUMERIC, Archiver::METRIC_OUTLINKS_RECORD_NAME), Record::make(Record::TYPE_NUMERIC, Archiver::METRIC_UNIQ_OUTLINKS_RECORD_NAME), Record::make(Record::TYPE_NUMERIC, Archiver::METRIC_PAGEVIEWS_RECORD_NAME), Record::make(Record::TYPE_NUMERIC, Archiver::METRIC_UNIQ_PAGEVIEWS_RECORD_NAME), Record::make(Record::TYPE_NUMERIC, Archiver::METRIC_SUM_TIME_RECORD_NAME), Record::make(Record::TYPE_NUMERIC, Archiver::METRIC_HITS_TIMED_RECORD_NAME), Record::make(Record::TYPE_NUMERIC, Archiver::METRIC_DOWNLOADS_RECORD_NAME), Record::make(Record::TYPE_NUMERIC, Archiver::METRIC_UNIQ_DOWNLOADS_RECORD_NAME)];
        if ($this->isFlatArchivingEnabled()) {
            $records[] = Record::make(Record::TYPE_BLOB, Archiver::PAGE_URLS_FLAT_RECORD_NAME)->setBlobColumnAggregationOps(Metrics::getColumnsAggregationOperation())->setMaxRowsInTable(ArchivingHelper::$maximumRowsInDataTableFlat);
            $records[] = Record::make(Record::TYPE_BLOB, Archiver::PAGE_TITLES_FLAT_RECORD_NAME)->setBlobColumnAggregationOps(Metrics::getColumnsAggregationOperation())->setMaxRowsInTable(ArchivingHelper::$maximumRowsInDataTableFlat);
        }
        return $records;
    }
    ...
    {
        ArchivingHelper::mergeHierarchicalActionsTableIntoBestEffortFlatTable($legacyHierarchy, $flatTable, Action::TYPE_PAGE_URL);
    }
    ...
    {
        ArchivingHelper::mergeHierarchicalActionsTableIntoBestEffortFlatTable($legacyHierarchy, $flatTable, Action::TYPE_PAGE_TITLE);
    }
    protected function aggregate(ArchiveProcessor $archiveProcessor) : array
    {
        ...
        $tableModesByType = [Action::TYPE_PAGE_URL => ArchivingHelper::ACTION_TABLE_MODE_FLAT, Action::TYPE_PAGE_TITLE => ArchivingHelper::ACTION_TABLE_MODE_FLAT];
        ...
        $this->archiveDayActions($archiveProcessor, $rankingQueryLimit, $dayTablesByType, array_diff(array_keys($dayTablesByType), [Action::TYPE_SITE_SEARCH]), \true, $tableModesByType);
        if ($archiveProcessor->getParams()->getSite()->isSiteSearchEnabled()) {
            ...
            $this->archiveDayActions($archiveProcessor, $rankingQueryLimitSiteSearch, $dayTablesByType, [Action::TYPE_SITE_SEARCH], \false, $tableModesByType);
        }
        ...
        $tablesByType[Action::TYPE_PAGE_URL] = $this->buildDayHierarchicalTableFromFlatTable($flatPageTablesByType[Action::TYPE_PAGE_URL], [$this, 'flatRowToUrlHierarchyPath']);
        $tablesByType[Action::TYPE_PAGE_TITLE] = $this->buildDayHierarchicalTableFromFlatTable($flatPageTablesByType[Action::TYPE_PAGE_TITLE], [$this, 'flatRowToTitleHierarchyPath']);
        $this->finalizeBuiltFromFlatHierarchyTable($archiveProcessor, $tablesByType[Action::TYPE_PAGE_URL], Archiver::PAGE_URLS_RECORD_NAME);
        $this->finalizeBuiltFromFlatHierarchyTable($archiveProcessor, $tablesByType[Action::TYPE_PAGE_TITLE], Archiver::PAGE_TITLES_RECORD_NAME);
        ...
        foreach ($tablesByType as $actionType => $dataTable) {
            if ($actionType === Action::TYPE_PAGE_URL || $actionType === Action::TYPE_PAGE_TITLE) {
                continue;
            }
    ...
    protected function beforeInsertBuiltFromFlatHierarchyRecord(ArchiveProcessor $archiveProcessor, Record $hierarchicalRecord, DataTable $hierarchicalTable, DataTable $flatTable) : void
    {
        $recordName = $hierarchicalRecord->getName();
        if ($recordName !== Archiver::PAGE_URLS_RECORD_NAME && $recordName !== Archiver::PAGE_TITLES_RECORD_NAME) {
            return;
        }
    ...
    private function flatRowToHierarchyPath(Row $flatRow, int $actionType) : ?array
    {
        ...
        if ($actionType === Action::TYPE_PAGE_URL) {
            ...
            return ArchivingHelper::getActionExplodedNames(ArchivingHelper::removePageUrlLeafMarkerFromFlatLabel($label), $actionType);
        }
    ...
    private function finalizeBuiltFromFlatHierarchyTable(ArchiveProcessor $archiveProcessor, DataTable $hierarchicalTable, string $recordName) : void
    {
        ...
        if ($recordName === Archiver::PAGE_URLS_RECORD_NAME) {
            ...
            $prefix = rtrim($prefix, '/') . '/';
            ArchivingHelper::setFolderPathMetadata($hierarchicalTable, $isUrl = \true, $prefix);
    ...
    private function setHierarchyBuiltFromFlatRecord(Record $record, string $flatRecordName, callable $flatToHierarchyPathCallback, callable $legacyHierarchyToFlatReducer) : void
    {
        $record->setBuiltFromFlatRecord($flatRecordName, $flatToHierarchyPathCallback, $legacyHierarchyToFlatReducer)->setMaxRowsInTable(0)->setMaxRowsInSubtable(0);
    }
    private function buildDayHierarchicalTableFromFlatTable(DataTable $flatTable, callable $flatToHierarchyPathCallback) : DataTable
    {
        return $this->buildHierarchicalTableFromFlatTable($flatTable, Metrics::getColumnsAggregationOperation(), $flatToHierarchyPathCallback, $this->getDefaultHierarchyRowColumns());
    }
    private function getDefaultHierarchyRowColumns() : array
    {
        return [PiwikMetrics::INDEX_NB_VISITS => 0, PiwikMetrics::INDEX_NB_UNIQ_VISITORS => 0, PiwikMetrics::INDEX_PAGE_NB_HITS => 0, PiwikMetrics::INDEX_PAGE_SUM_TIME_SPENT => 0];
    }
    private function aggregateLegacyHierarchical(ArchiveProcessor $archiveProcessor) : array
    {
        ...
        ArchivingHelper::reloadConfig();
        $tablesByType = $this->makeReportTables();
        $this->archiveDayActions($archiveProcessor, $rankingQueryLimit, $tablesByType, array_diff(array_keys($tablesByType), [Action::TYPE_SITE_SEARCH]), \true);
        if ($archiveProcessor->getParams()->getSite()->isSiteSearchEnabled()) {
            $rankingQueryLimitSiteSearch = max($rankingQueryLimit, ArchivingHelper::$maximumRowsInDataTableSiteSearch);
        ...
        $prefix = $archiveProcessor->getParams()->getSite()->getMainUrl();
        $prefix = rtrim($prefix, '/') . '/';
        ArchivingHelper::setFolderPathMetadata($tablesByType[Action::TYPE_PAGE_URL], $isUrl = \true, $prefix);
        ...
        $nbDownloads = array_sum($dataTable->getColumn(PiwikMetrics::INDEX_PAGE_NB_HITS));
        $nbUniqDownloads = array_sum($dataTable->getColumn(PiwikMetrics::INDEX_NB_VISITS));
        return [Archiver::PAGE_URLS_RECORD_NAME => $tablesByType[Action::TYPE_PAGE_URL], Archiver::PAGE_TITLES_RECORD_NAME => $tablesByType[Action::TYPE_PAGE_TITLE], Archiver::DOWNLOADS_RECORD_NAME => $tablesByType[Action::TYPE_DOWNLOAD], Archiver::OUTLINKS_RECORD_NAME => $tablesByType[Action::TYPE_OUTLINK], Archiver::SITE_SEARCH_RECORD_NAME => $tablesByType[Action::TYPE_SITE_SEARCH], Archiver::METRIC_SEARCHES_RECORD_NAME => $nbSearches, Archiver::METRIC_KEYWORDS_RECORD_NAME => $nbKeywords, Archiver::METRIC_OUTLINKS_RECORD_NAME => $nbOutlinks, Archiver::METRIC_UNIQ_OUTLINKS_RECORD_NAME => $nbUniqOutlinks, Archiver::METRIC_PAGEVIEWS_RECORD_NAME => $nbPageviews, Archiver::METRIC_UNIQ_PAGEVIEWS_RECORD_NAME => $nbUniqPageviews, Archiver::METRIC_SUM_TIME_RECORD_NAME => $nbSumTimeGeneration, Archiver::METRIC_HITS_TIMED_RECORD_NAME => $nbHitsWithTimeGeneration, Archiver::METRIC_DOWNLOADS_RECORD_NAME => $nbDownloads, Archiver::METRIC_UNIQ_DOWNLOADS_RECORD_NAME => $nbUniqDownloads];
    }
    protected function deleteUnusedColumnsFromKeywordsDataTable(DataTable $dataTable) : void
    {
        $columnsToDelete = array(PiwikMetrics::INDEX_NB_UNIQ_VISITORS, PiwikMetrics::INDEX_PAGE_IS_FOLLOWING_SITE_SEARCH_NB_HITS, PiwikMetrics::INDEX_PAGE_ENTRY_NB_UNIQ_VISITORS, PiwikMetrics::INDEX_PAGE_ENTRY_NB_ACTIONS, PiwikMetrics::INDEX_PAGE_ENTRY_SUM_VISIT_LENGTH, PiwikMetrics::INDEX_PAGE_ENTRY_NB_VISITS, PiwikMetrics::INDEX_PAGE_ENTRY_BOUNCE_COUNT, PiwikMetrics::INDEX_PAGE_EXIT_NB_UNIQ_VISITORS);
    ...
    protected function archiveDayActions(ArchiveProcessor $archiveProcessor, int $rankingQueryLimit, array $actionsTablesByType, $actionTypes, bool $includePageNotDefined, array $tableModesByType = []) : void
    {
        ...
        $where .= " AND log_link_visit_action.%s IS NOT NULL" . $this->getWhereClauseActionIsNotEvent();
        ...
        $this->archiveDayQueryProcess($logAggregator, $actionsTablesByType, $select, $from, $where, $groupBy, $orderBy, "idaction_name", $rankingQuery, $metricsConfig, $tableModesByType);
        $this->archiveDayQueryProcess($logAggregator, $actionsTablesByType, $select, $from, $where, $groupBy, $orderBy, "idaction_url", $rankingQuery, $metricsConfig, $tableModesByType);
    }
    /**
    ...
    protected function archiveDayEntryActions(LogAggregator $logAggregator, array $actionsTablesByType, int $rankingQueryLimit, array $tableModesByType = [])
    {
        ...
        if ($rankingQueryLimit > 0) {
            ...
            $rankingQuery->addColumn(array(PiwikMetrics::INDEX_PAGE_ENTRY_NB_VISITS, PiwikMetrics::INDEX_PAGE_ENTRY_NB_ACTIONS, PiwikMetrics::INDEX_PAGE_ENTRY_SUM_VISIT_LENGTH, PiwikMetrics::INDEX_PAGE_ENTRY_BOUNCE_COUNT), 'sum');
        ...
        $groupBy = "log_visit.%s";
        $this->archiveDayQueryProcess($logAggregator, $actionsTablesByType, $select, $from, $where, $groupBy, $orderBy, "visit_entry_idaction_url", $rankingQuery, [], $tableModesByType);
        $this->archiveDayQueryProcess($logAggregator, $actionsTablesByType, $select, $from, $where, $groupBy, $orderBy, "visit_entry_idaction_name", $rankingQuery, [], $tableModesByType);
    }
    /**
     * Exit actions
     */
    protected function archiveDayExitActions(LogAggregator $logAggregator, array $actionsTablesByType, int $rankingQueryLimit, array $tableModesByType = [])
    {
        ...
        $where .= " AND log_visit.%s > 0";
        $groupBy = "log_visit.%s";
        $this->archiveDayQueryProcess($logAggregator, $actionsTablesByType, $select, $from, $where, $groupBy, $orderBy, "visit_exit_idaction_url", $rankingQuery, [], $tableModesByType);
        $this->archiveDayQueryProcess($logAggregator, $actionsTablesByType, $select, $from, $where, $groupBy, $orderBy, "visit_exit_idaction_name", $rankingQuery, [], $tableModesByType);
    ...
    protected function archiveDayActionsTime(LogAggregator $logAggregator, array $actionsTablesByType, int $rankingQueryLimit, array $tableModesByType = [])
    {
        ...
        $groupBy = "log_link_visit_action.%s";
        $this->archiveDayQueryProcess($logAggregator, $actionsTablesByType, $select, $from, $where, $groupBy, $orderBy, "idaction_url_ref", $rankingQuery, [], $tableModesByType);
        $this->archiveDayQueryProcess($logAggregator, $actionsTablesByType, $select, $from, $where, $groupBy, $orderBy, "idaction_name_ref", $rankingQuery, [], $tableModesByType);
    }
    protected function archiveDayQueryProcess(LogAggregator $logAggregator, array $actionsTablesByType, string $select, $from, string $where, string $groupBy, $orderBy, string $sprintfField, ?RankingQuery $rankingQuery = null, array $metricsConfig = array(), array $tableModesByType = []) : void
    {
        ...
        ArchivingHelper::updateActionsTableWithRowQuery($resultSet, $sprintfField, $actionsTablesByType, $metricsConfig, $tableModesByType);
    }
    ...
    protected function archiveDayActionsGoals(ArchiveProcessor $archiveProcessor, int $rankingQueryLimit) : void
    {
        ...
        if (!\Piwik\Common::isGoalPluginEnabled() || GeneralConfig::getConfigValue('disable_archive_actions_goals', $site->getId())) {
            return;
        }
        ...
        foreach ($goals as $idGoal) {
            $this->archiveDayActionsGoalsPages($archiveProcessor->getLogAggregator(), \true, $idGoal);
            $this->archiveDayActionsGoalsPages($archiveProcessor->getLogAggregator(), \false, $idGoal);
        }
        $this->archiveDayActionsGoalsPagesEntry($archiveProcessor, $rankingQueryLimit, \true);
    ...
    protected function archiveDayActionsGoalsPages(LogAggregator $logAggregator, bool $isUrl, int $idGoal) : ?int
    {
        ...
        return ArchivingHelper::updateActionsTableWithGoals($resultSet, \true);
    }
    /**
