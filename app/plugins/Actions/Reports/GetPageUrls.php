...
class GetPageUrls extends \Piwik\Plugins\Actions\Reports\Base
{
    ...
    {
        return [ReportsProvider::factory('Actions', 'getEntryPageUrls'), ReportsProvider::factory('Actions', 'getExitPageUrls')];
    }
}
