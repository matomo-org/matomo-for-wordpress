...
class GetPageTitles extends \Piwik\Plugins\Actions\Reports\Base
{
    ...
    public function configureView(ViewDataTable $view)
    {
        ...
        $view->config->columns_to_display = array('label', 'nb_hits', 'nb_visits', 'bounce_rate', 'avg_time_on_page', 'exit_rate');
    ...
    {
        return array(ReportsProvider::factory('Actions', 'getEntryPageTitles'), ReportsProvider::factory('Actions', 'getExitPageTitles'));
    }
}
