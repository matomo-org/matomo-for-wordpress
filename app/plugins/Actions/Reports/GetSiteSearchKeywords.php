...
class GetSiteSearchKeywords extends \Piwik\Plugins\Actions\Reports\SiteSearchBase
{
    ...
    {
        return array('nb_visits' => Piwik::translate('Actions_ColumnSearches'), 'nb_pages_per_search' => Piwik::translate('Actions_ColumnPagesPerSearch'));
    }
