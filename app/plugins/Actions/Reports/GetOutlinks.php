...
class GetOutlinks extends \Piwik\Plugins\Actions\Reports\Base
{
    ...
    {
        return array('nb_visits' => Piwik::translate('Actions_ColumnUniqueClicks'), 'nb_hits' => Piwik::translate('Actions_ColumnClicks'));
    }
