...
abstract class BaseItem extends \Piwik\Plugins\Ecommerce\Reports\Base
{
    ...
    public function getMetricsDocumentation()
    {
        if ($this->isAbandonedCart(\false)) {
            return ['revenue' => Piwik::translate('Goals_ColumnRevenueLeftInCartDocumentation'), 'quantity' => Piwik::translate('Goals_ColumnQuantityLeftInCartDocumentation', $this->name), 'avg_price' => Piwik::translate('Goals_ColumnAveragePriceDocumentation', $this->name), 'avg_quantity' => Piwik::translate('Goals_ColumnAverageQuantityDocumentation', $this->name), 'nb_visits' => Piwik::translate('Goals_ColumnVisitsProductDocumentation', $this->name), 'abandoned_carts' => Piwik::translate('Goals_ColumnAbandonedCartsDocumentation', $this->name)];
        } else {
