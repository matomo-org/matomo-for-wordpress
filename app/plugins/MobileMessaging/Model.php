...
class Model
{
    ...
    public function getSMSAPICredential()
    {
        ...
        if (!empty($credentials) && !is_array($credentials)) {
            $credentials = array('apiKey' => $credentials);
        }
        return array(\Piwik\Plugins\MobileMessaging\MobileMessaging::PROVIDER_OPTION => isset($settings[\Piwik\Plugins\MobileMessaging\MobileMessaging::PROVIDER_OPTION]) ? $settings[\Piwik\Plugins\MobileMessaging\MobileMessaging::PROVIDER_OPTION] : null, \Piwik\Plugins\MobileMessaging\MobileMessaging::API_KEY_OPTION => $credentials);
    }
    /**
    ...
    {
        $optionIndex = $user . \Piwik\Plugins\MobileMessaging\MobileMessaging::USER_SETTINGS_POSTFIX_OPTION;
