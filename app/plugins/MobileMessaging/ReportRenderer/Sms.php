...
class Sms extends ReportRenderer
{
    ...
    public function renderReport($processedReport)
    {
        ...
        $reportData->filter('ColumnCallbackReplace', [array_merge(array_keys($multiSitesAPIMetrics), $evolutionMetrics), function ($value) use($floatRegex) {
        ...
        $reportData->filter('ColumnCallbackReplace', [$evolutionMetrics, function ($value) use($floatRegex) {
