    ...
    protected function doExecute() : int
    {
        ...
        foreach ($pluginList as $plugin) {
            ...
            foreach ($files as $filename) {
                ...
                $this->runCommand('translations:set', ['--code' => $code, '--file' => $filename, '--plugin' => $plugin], !$output->isVeryVerbose());
            }
