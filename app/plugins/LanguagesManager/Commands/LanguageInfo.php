...
class LanguageInfo extends \Piwik\Plugins\LanguagesManager\Commands\TranslationBase
{
    ...
    {
        $this->setName('translations:languageinfo')->addNoValueOption('all', 'a', 'Displays all languages (ignores language configuration)')->setDescription('Shows available languages info');
    }
