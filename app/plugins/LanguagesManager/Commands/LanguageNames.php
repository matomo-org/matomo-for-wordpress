...
class LanguageNames extends \Piwik\Plugins\LanguagesManager\Commands\TranslationBase
{
    ...
    {
        $this->setName('translations:languagenames')->addNoValueOption('all', 'a', 'Displays all languages (ignores language configuration)')->setDescription('Shows available language names');
    }
