...
class BruteForceDetection
{
    ...
    private function sendSuspiciousLoginsEmailToUser($login, $countOverall)
    {
        ...
        try {
            ...
            $email = StaticContainer::getContainer()->make(SuspiciousLoginAttemptsInLastHourEmail::class, ['login' => $login, 'countOverall' => $countOverall, 'countDistinctIps' => $distinctIps]);
            $email->send();
