...
class PasswordResetter
{
     ...
     */
    public function setHashedPasswordForLogin($login, #[\SensitiveParameter] $passwordHash)
    {
        /*
    ...
    public function doesResetPasswordHashMatchesPassword(#[\SensitiveParameter] $passwordPlain, #[\SensitiveParameter] $passwordHash)
    {
     ...
     */
    protected function checkNewPassword(#[\SensitiveParameter] $newPassword)
    {
     ...
     */
    protected function checkPasswordHash(#[\SensitiveParameter] $passwordHash)
    {
     ...
     */
    private function savePasswordResetInfo($login, #[\SensitiveParameter] $newPassword, $keySuffix)
    {
