...
class Metrics
{
    ...
    public static $mappingFromIdToName = array(
        ...
        \Piwik\Metrics::INDEX_NB_ACTIONS => 'nb_actions',
        \Piwik\Metrics::INDEX_NB_USERS => 'nb_users',
        \Piwik\Metrics::INDEX_MAX_ACTIONS => 'max_actions',
        \Piwik\Metrics::INDEX_SUM_VISIT_LENGTH => 'sum_visit_length',
        \Piwik\Metrics::INDEX_BOUNCE_COUNT => 'bounce_count',
        \Piwik\Metrics::INDEX_NB_VISITS_CONVERTED => 'nb_visits_converted',
        \Piwik\Metrics::INDEX_NB_CONVERSIONS => 'nb_conversions',
        \Piwik\Metrics::INDEX_REVENUE => 'revenue',
        ...
        \Piwik\Metrics::INDEX_PAGE_SUM_TIME_GENERATION => 'sum_time_generation',
        \Piwik\Metrics::INDEX_PAGE_NB_HITS_WITH_TIME_GENERATION => 'nb_hits_with_time_generation',
        \Piwik\Metrics::INDEX_PAGE_MIN_TIME_GENERATION => 'min_time_generation',
        \Piwik\Metrics::INDEX_PAGE_MAX_TIME_GENERATION => 'max_time_generation',
        \Piwik\Metrics::INDEX_PAGE_EXIT_NB_UNIQ_VISITORS => 'exit_nb_uniq_visitors',
        \Piwik\Metrics::INDEX_PAGE_EXIT_NB_VISITS => 'exit_nb_visits',
        \Piwik\Metrics::INDEX_PAGE_EXIT_SUM_DAILY_NB_UNIQ_VISITORS => 'sum_daily_exit_nb_uniq_visitors',
        \Piwik\Metrics::INDEX_PAGE_ENTRY_NB_UNIQ_VISITORS => 'entry_nb_uniq_visitors',
        \Piwik\Metrics::INDEX_PAGE_ENTRY_SUM_DAILY_NB_UNIQ_VISITORS => 'sum_daily_entry_nb_uniq_visitors',
        \Piwik\Metrics::INDEX_PAGE_ENTRY_NB_VISITS => 'entry_nb_visits',
        \Piwik\Metrics::INDEX_PAGE_ENTRY_NB_ACTIONS => 'entry_nb_actions',
        \Piwik\Metrics::INDEX_PAGE_ENTRY_SUM_VISIT_LENGTH => 'entry_sum_visit_length',
        \Piwik\Metrics::INDEX_PAGE_ENTRY_BOUNCE_COUNT => 'entry_bounce_count',
        \Piwik\Metrics::INDEX_PAGE_IS_FOLLOWING_SITE_SEARCH_NB_HITS => 'nb_hits_following_search',
        // Items reports metrics
        \Piwik\Metrics::INDEX_ECOMMERCE_ITEM_REVENUE => 'revenue',
        \Piwik\Metrics::INDEX_ECOMMERCE_ITEM_QUANTITY => 'quantity',
        \Piwik\Metrics::INDEX_ECOMMERCE_ITEM_PRICE => 'price',
        \Piwik\Metrics::INDEX_ECOMMERCE_ITEM_PRICE_VIEWED => 'price_viewed',
        \Piwik\Metrics::INDEX_ECOMMERCE_ORDERS => 'orders',
        // Events
        \Piwik\Metrics::INDEX_EVENT_NB_HITS => 'nb_events',
        \Piwik\Metrics::INDEX_EVENT_SUM_EVENT_VALUE => 'sum_event_value',
        \Piwik\Metrics::INDEX_EVENT_MIN_EVENT_VALUE => 'min_event_value',
        \Piwik\Metrics::INDEX_EVENT_MAX_EVENT_VALUE => 'max_event_value',
        \Piwik\Metrics::INDEX_EVENT_NB_HITS_WITH_VALUE => 'nb_events_with_value',
        // Contents
    ...
    public static function getMappingFromIdToName()
    {
        ...
        if (empty($value)) {
             ...
             * @ignore
             */
            \Piwik\Piwik::postEvent('Metrics.addMetricIdToNameMapping', [&$value]);
    ...
    public static function getUnit($column, $idSite)
    {
         ...
         */
        \Piwik\Piwik::postEvent('Metrics.getEvolutionUnit', [&$unit, $column, $idSite]);
        if (!empty($unit)) {
            return $unit;
        }
    ...
    public static function getDefaultMetricSemanticTypes() : array
    {
        ...
        if (empty($types)) {
             ...
             */
            \Piwik\Piwik::postEvent('Metrics.getDefaultMetricSemanticTypes', [&$types]);
    ...
    public static function getDefaultMetricTranslations()
    {
        ...
        $translations['sum_daily_nb_users'] = \Piwik\Piwik::translate('General_ColumnNbUsers') . $dailySum;
        $translations['sum_daily_entry_nb_uniq_visitors'] = \Piwik\Piwik::translate('General_ColumnUniqueEntrances') . $dailySum;
        $translations['sum_daily_exit_nb_uniq_visitors'] = \Piwik\Piwik::translate('General_ColumnUniqueExits') . $dailySum;
        $translations['entry_nb_actions'] = \Piwik\Piwik::translate('General_ColumnNbActions') . $afterEntry;
        $translations['entry_sum_visit_length'] = \Piwik\Piwik::translate('General_ColumnSumVisitLength') . $afterEntry;
         ...
         */
        \Piwik\Piwik::postEvent('Metrics.getDefaultMetricTranslations', array(&$translations));
    ...
    public static function getDefaultMetricsDocumentation()
    {
         ...
         */
        \Piwik\Piwik::postEvent('Metrics.getDefaultMetricDocumentationTranslations', array(&$translations));
        $translations = array_map(array('\\Piwik\\Piwik', 'translate'), $translations);
        $cache->save($cacheId, $translations);
        return $translations;
    }
    ...
    public static function makeGoalColumnsRow(int $idGoal, array $goalsMetrics) : array
    {
        if ($idGoal > GoalManager::IDGOAL_ORDER) {
            // user defined goal
            $columns = [\Piwik\Metrics::INDEX_GOAL_NB_CONVERSIONS, \Piwik\Metrics::INDEX_GOAL_NB_VISITS_CONVERTED, \Piwik\Metrics::INDEX_GOAL_REVENUE];
            ...
            // idGoal == GoalManager::IDGOAL_CART (abandoned cart)
            $columns = [\Piwik\Metrics::INDEX_GOAL_NB_CONVERSIONS, \Piwik\Metrics::INDEX_GOAL_NB_VISITS_CONVERTED, \Piwik\Metrics::INDEX_GOAL_REVENUE, \Piwik\Metrics::INDEX_GOAL_ECOMMERCE_ITEMS];
        }
        $values = [];
