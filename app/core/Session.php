...
class Session extends Zend_Session
{
    ...
    public static function getSameSiteCookieValue()
    {
         ...
         * });
         */
        \Piwik\Piwik::postEvent('Session.shouldSendSameSiteCookieAsNoneForcefully', [&$shouldUseNoneForcefully]);
        if (($shouldUseNone || $shouldUseNoneForcefully) && \Piwik\ProxyHttp::isHttps()) {
            return 'None';
        }
        return 'Lax';
    }
