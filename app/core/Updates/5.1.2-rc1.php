...
class Updates_5_1_2_rc1 extends Updates
{
    ...
    public function getMigrations(Updater $updater)
    {
        ...
        if (empty($dbConfig['collation'])) {
            ...
            if (null !== $collation) {
                $migrations[] = $this->migration->config->set('database', 'collation', $collation);
            }
        }
        return $migrations;
    }
    ...
    private function detectCollationForMigration() : ?string
    {
        try {
            ...
            if (!empty($archiveTableStatus['Collation']) && $archiveTableStatus['Collation'] === $userTableCollation) {
