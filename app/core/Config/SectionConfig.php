...
abstract class SectionConfig
{
    ...
    {
        StaticContainer::get(LoggerInterface::class)->warning('Failed to cast config value {section}.{name} to {type}; actual type was {actualType}.', ['section' => static::getSectionName(), 'name' => $name, 'type' => $type, 'actualType' => self::getValueType($value)]);
    }
    /**
     * @param mixed $value
     */
