...
{
    protected $fieldsThatRequireAuth = ['city', 'region', 'country', 'lat', 'long'];
    protected function checkSiteExists(\Piwik\Tracker\Request $request) : void
    {
        try {
            $request->getIdSite();
    ...
    protected function validateRequest(\Piwik\Tracker\Request $request) : void
    {
    ...
    protected function markArchivedReportsAsInvalidIfArchiveAlreadyFinished(\Piwik\Tracker\Request $request) : void
    {
