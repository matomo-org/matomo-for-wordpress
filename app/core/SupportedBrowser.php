...
class SupportedBrowser
{
     ...
     * $ npx browserslist
     */
    private static $notSupportedBrowsers = ['FF' => 51, 'IE' => 11, 'SF' => 10, 'CH' => 48, 'OP' => 72, 'PS' => 17];
    ...
    {
        $message = "<p><b>" . \Piwik\Piwik::translate('General_ExceptionNotSupportedBrowserTitle') . "</b></p>";
        $message .= "<p>" . \Piwik\Piwik::translate('General_ExceptionNotSupportedBrowserText') . "</p>";
