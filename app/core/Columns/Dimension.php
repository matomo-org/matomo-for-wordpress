...
abstract class Dimension
{
    ...
    */
    public function install()
    {
        ...
        return array($this->dbTableName => array("ADD COLUMN `{$this->columnName}` {$this->columnType}"));
    }
    /**
    ...
    */
    public function update()
    {
        ...
        return array($this->dbTableName => array("MODIFY COLUMN `{$this->columnName}` {$this->columnType}"));
    }
    /**
    ...
    public function getSegments()
    {
        ...
        $this->configureSegments($list, new \Piwik\Columns\DimensionSegmentFactory($this));
