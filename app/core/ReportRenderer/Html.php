...
class Html extends ReportRenderer
{
    ...
    {
        $frontPageView = new View\HtmlReportEmailHeaderView($reportTitle, $prettyDate, $description, $reportMetadata, $segment, $this->idSite, $this->report['period']);
    ...
    protected function getAttachment($report, $processedReport, $prettyDate)
    {
        ...
        $additionalFile['content'] = ReportRenderer::getStaticGraph($processedReportMetadata, \Piwik\ReportRenderer\Html::IMAGE_GRAPH_WIDTH, \Piwik\ReportRenderer\Html::IMAGE_GRAPH_HEIGHT, $processedReport['evolutionGraph'], $segment);
