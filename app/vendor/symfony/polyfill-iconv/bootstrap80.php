...
namespace {
    ...
    if (\extension_loaded('mbstring')) {
        if (!\function_exists('iconv_strlen')) {
            ...
            {
                null === $encoding && ($encoding = p\Iconv::$internalEncoding);
        ...
        if (!\function_exists('iconv_strpos')) {
            ...
            {
                null === $encoding && ($encoding = p\Iconv::$internalEncoding);
                return \mb_strpos((string) $haystack, (string) $needle, (int) $offset, $encoding);
            }
        }
        if (!\function_exists('iconv_strrpos')) {
            ...
            {
                null === $encoding && ($encoding = p\Iconv::$internalEncoding);
                return \mb_strrpos((string) $haystack, (string) $needle, 0, $encoding);
            }
        }
        ...
        if (!\function_exists('iconv_mime_decode')) {
            ...
            {
                $currentMbEncoding = \mb_internal_encoding();
                null === $encoding && ($encoding = p\Iconv::$internalEncoding);
