 ...
 */
namespace Matomo\Dependencies\Symfony\Bridge\Monolog\Command;
...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($this->getLogs($socket) as $clientId => $message) {
            $record = @unserialize(base64_decode($message), ['allowed_classes' => [Data::class, Stub::class]]);
            if (!\is_array($record)) {
                continue;
            }
