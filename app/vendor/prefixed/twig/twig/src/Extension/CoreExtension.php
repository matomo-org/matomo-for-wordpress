...
final class CoreExtension extends AbstractExtension
{
    ...
    public function getFilters() : array
    {
        return [
            // formatting filters
            new TwigFilter('date', '\Matomo\Dependencies\twig_date_format_filter', ['needs_environment' => true]),
            new TwigFilter('date_modify', '\Matomo\Dependencies\twig_date_modify_filter', ['needs_environment' => true]),
            new TwigFilter('format', '\Matomo\Dependencies\twig_sprintf'),
            new TwigFilter('replace', '\Matomo\Dependencies\twig_replace_filter'),
            new TwigFilter('number_format', '\Matomo\Dependencies\twig_number_format_filter', ['needs_environment' => true]),
            new TwigFilter('abs', 'abs'),
            new TwigFilter('round', '\Matomo\Dependencies\twig_round'),
            // encoding
            new TwigFilter('url_encode', '\Matomo\Dependencies\twig_urlencode_filter'),
            new TwigFilter('json_encode', 'json_encode'),
            new TwigFilter('convert_encoding', '\Matomo\Dependencies\twig_convert_encoding'),
            // string filters
            new TwigFilter('title', '\Matomo\Dependencies\twig_title_string_filter', ['needs_environment' => true]),
            new TwigFilter('capitalize', '\Matomo\Dependencies\twig_capitalize_string_filter', ['needs_environment' => true]),
            new TwigFilter('upper', '\Matomo\Dependencies\twig_upper_filter', ['needs_environment' => true]),
            new TwigFilter('lower', '\Matomo\Dependencies\twig_lower_filter', ['needs_environment' => true]),
            new TwigFilter('striptags', '\Matomo\Dependencies\twig_striptags'),
            new TwigFilter('trim', '\Matomo\Dependencies\twig_trim_filter'),
            new TwigFilter('nl2br', '\Matomo\Dependencies\twig_nl2br', ['pre_escape' => 'html', 'is_safe' => ['html']]),
            new TwigFilter('spaceless', '\Matomo\Dependencies\twig_spaceless', ['is_safe' => ['html']]),
            // array helpers
            new TwigFilter('join', '\Matomo\Dependencies\twig_join_filter'),
            new TwigFilter('split', '\Matomo\Dependencies\twig_split_filter', ['needs_environment' => true]),
            new TwigFilter('sort', '\Matomo\Dependencies\twig_sort_filter', ['needs_environment' => true]),
            new TwigFilter('merge', '\Matomo\Dependencies\twig_array_merge'),
            new TwigFilter('batch', '\Matomo\Dependencies\twig_array_batch'),
            new TwigFilter('column', '\Matomo\Dependencies\twig_array_column'),
            new TwigFilter('filter', '\Matomo\Dependencies\twig_array_filter', ['needs_environment' => true]),
            new TwigFilter('map', '\Matomo\Dependencies\twig_array_map', ['needs_environment' => true]),
            new TwigFilter('reduce', '\Matomo\Dependencies\twig_array_reduce', ['needs_environment' => true]),
            // string/array filters
            new TwigFilter('reverse', '\Matomo\Dependencies\twig_reverse_filter', ['needs_environment' => true]),
            new TwigFilter('length', '\Matomo\Dependencies\twig_length_filter', ['needs_environment' => true]),
            new TwigFilter('slice', '\Matomo\Dependencies\twig_slice', ['needs_environment' => true]),
            new TwigFilter('first', '\Matomo\Dependencies\twig_first', ['needs_environment' => true]),
            new TwigFilter('last', '\Matomo\Dependencies\twig_last', ['needs_environment' => true]),
            // iteration and runtime
            new TwigFilter('default', '\Matomo\Dependencies\_twig_default_filter', ['node_class' => DefaultFilter::class]),
            new TwigFilter('keys', '\Matomo\Dependencies\twig_get_array_keys_filter'),
        ];
    }
    public function getFunctions() : array
    {
        return [new TwigFunction('max', 'max'), new TwigFunction('min', 'min'), new TwigFunction('range', 'range'), new TwigFunction('constant', '\Matomo\Dependencies\twig_constant'), new TwigFunction('cycle', '\Matomo\Dependencies\twig_cycle'), new TwigFunction('random', '\Matomo\Dependencies\twig_random', ['needs_environment' => true]), new TwigFunction('date', '\Matomo\Dependencies\twig_date_converter', ['needs_environment' => true]), new TwigFunction('include', '\Matomo\Dependencies\twig_include', ['needs_environment' => true, 'needs_context' => true, 'is_safe' => ['all']]), new TwigFunction('source', '\Matomo\Dependencies\twig_source', ['needs_environment' => true, 'is_safe' => ['all']])];
    }
    public function getTests() : array
    {
        return [new TwigTest('even', null, ['node_class' => EvenTest::class]), new TwigTest('odd', null, ['node_class' => OddTest::class]), new TwigTest('defined', null, ['node_class' => DefinedTest::class]), new TwigTest('same as', null, ['node_class' => SameasTest::class, 'one_mandatory_argument' => true]), new TwigTest('none', null, ['node_class' => NullTest::class]), new TwigTest('null', null, ['node_class' => NullTest::class]), new TwigTest('divisible by', null, ['node_class' => DivisiblebyTest::class, 'one_mandatory_argument' => true]), new TwigTest('constant', null, ['node_class' => ConstantTest::class]), new TwigTest('empty', '\Matomo\Dependencies\twig_test_empty'), new TwigTest('iterable', 'is_iterable')];
    }
...
{
    if (!$arrow instanceof \Closure && $env->hasExtension('Matomo\\Dependencies\\Twig\\Extension\\SandboxExtension') && $env->getExtension('Matomo\\Dependencies\\Twig\\Extension\\SandboxExtension')->isSandboxed()) {
