...
namespace {
    ...
    class QRcode
    {
        ...
        protected function encodeMask($mask)
        {
            ...
            for ($i = 0; $i < $this->dataLength + $this->eccLength; $i++) {
                ...
                for ($j = 0; $j < 8; $j++) {
                    ...
                    $this->setFrameAt($addr, 0x2 | ($bit & $code) != 0);
                    $bit = $bit >> 1;
                }
            }
            // remainder bits
        ...
        protected function encodeModeAn($inputitem, $version)
        {
            ...
            $inputitem['bstream'] = array();
            $inputitem['bstream'] = $this->appendNum($inputitem['bstream'], 4, 0x2);
        ...
        {
            $inputitem['bstream'] = array();
            $inputitem['bstream'] = $this->appendNum($inputitem['bstream'], 4, 0x3);
