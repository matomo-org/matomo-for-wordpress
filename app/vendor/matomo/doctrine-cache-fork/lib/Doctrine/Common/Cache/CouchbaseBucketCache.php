 ...
 */
final class CouchbaseBucketCache extends \Doctrine\Common\Cache\CacheProvider
{
    ...
    protected function doGetStats()
    {
        ...
        return [\Doctrine\Common\Cache\Cache::STATS_HITS => $interestingStats['get_hits'], \Doctrine\Common\Cache\Cache::STATS_MISSES => $interestingStats['cmd_get'] - $interestingStats['get_hits'], \Doctrine\Common\Cache\Cache::STATS_UPTIME => $node['uptime'], \Doctrine\Common\Cache\Cache::STATS_MEMORY_USAGE => $interestingStats['mem_used'], \Doctrine\Common\Cache\Cache::STATS_MEMORY_AVAILABLE => $node['memoryFree']];
    }
