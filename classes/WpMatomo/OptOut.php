...
class OptOut extends Feature {
	...
	public function load_scripts() {
		if ( ! is_admin() ) {
			wp_register_script( 'matomo_opt_out_js', plugins_url( 'assets/js/optout.js', MATOMO_ANALYTICS_FILE ), [], \WpMatomo::get_asset_version(), true );
		}
	}
	...
	public function show_opt_out( $atts ) {
		...
		wp_enqueue_script( 'matomo_opt_out_form_js', $url, [], \WpMatomo::get_asset_version(), true ); // output in the footer
