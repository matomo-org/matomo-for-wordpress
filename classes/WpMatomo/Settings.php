...
class Settings {
	...
	const ONLY_TRACK_ECOMMERCE_IF_VISITOR_ID_PRESENT_OPTION_NAME = 'only_track_if_visitor_id_present';
	...
	private $default_blog_settings = [
		...
		self::ONLY_TRACK_ECOMMERCE_IF_VISITOR_ID_PRESENT_OPTION_NAME => true,
	];
