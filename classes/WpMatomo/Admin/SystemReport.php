		...
		if ( ! empty( $active_plugins ) && is_array( $active_plugins ) ) {
			...
			if ( ! empty( $used_not_compatible ) ) {
				...
				if ( in_array( 'wp-rocket', $used_not_compatible, true ) ) {
					$additional_comment .= '<br><br>Wp-rocket is incompatible from version 3.12. Until fixes, please <a href="https://github.com/matomo-org/matomo-for-wordpress/wiki/Downgrade-wp-rocket-to-a-version-compatible-with-the-Matomo-plugin" target="_blank"> reinstall version 3.11.5 if you have a newer version.</a>';
				}
