<h1><?php _e( 'About Matomo Analytics', 'matomo' ); ?></h1>

<p>
	<?php echo sprintf( __( '%1$sMatomo Analytics%2$s is the most powerful
    ...
    data is stored in your WordPress. You own the data, nobody else.', 'matomo' ),
