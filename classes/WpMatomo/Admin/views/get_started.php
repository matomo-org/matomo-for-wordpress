...
<div class="wrap">
	...
	<?php echo sprintf(esc_html__( 'If GDPR applies to you: By %1$sdisabling cookies in the tracking settings%2$s, you %3$smight not need to ask for any consent%4$s.', 'matomo' ), '<a href="'.AdminSettings::make_url( AdminSettings::TAB_TRACKING ).'" target="_blank" rel="noreferrer noopener">', '</a>', '<a href="https://matomo.org/faq/new-to-piwik/how-do-i-use-matomo-analytics-without-consent-or-cookie-banner/" target="_blank" rel="noreferrer noopener">', '</a>'); ?>
