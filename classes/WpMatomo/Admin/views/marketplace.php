			...
			'features'        =>
				[
					[
						...
						'price'       => '69EUR / 79USD',
						'url'         => matomo_decorate_goal_url( 'https://plugins.matomo.org/CrashAnalytics?pk_campaign=WP&pk_source=Plugin' ),
						'image'       => '',
					],
				],
		],
			...
			'features'  =>
				[
					[
						...
						'price'        => 'free',
						'download_url' => matomo_decorate_goal_url( 'https://plugins.matomo.org/api/2.0/plugins/MarketingCampaignsReporting/download/latest' . $matomo_extra_url_params ),
						'url'          => matomo_decorate_goal_url( 'https://plugins.matomo.org/MarketingCampaignsReporting?pk_campaign=WP&pk_source=Plugin' ),
						'image'        => '',
					],
					[
						'name'         => 'Custom Alerts',
						...
						'price'        => 'free',
						'download_url' => matomo_decorate_goal_url( 'https://plugins.matomo.org/api/2.0/plugins/CustomAlerts/download/latest' . $matomo_extra_url_params ),
						'url'          => matomo_decorate_goal_url( 'https://plugins.matomo.org/CustomAlerts?pk_campaign=WP&pk_source=Plugin' ),
						'image'        => '',
					],
				],
		],
			...
			'features' =>
				[
					[
						...
						'price'       => '99EUR / 119USD',
						'url'         => matomo_decorate_goal_url( 'https://plugins.matomo.org/HeatmapSessionRecording?pk_campaign=WP&pk_source=Plugin' ),
						'image'       => '',
					],
					[
						'name'        => 'Custom Reports',
						...
						'price'       => '99EUR / 119USD',
						'url'         => matomo_decorate_goal_url( 'https://plugins.matomo.org/CustomReports?pk_campaign=WP&pk_source=Plugin' ),
						'image'       => '',
					],
					...
					[
						...
						'price'       => '499EUR / 579USD',
						'url'         => matomo_decorate_goal_url( 'https://plugins.matomo.org/WpPremiumBundle?pk_campaign=WP&pk_source=Plugin' ),
						'image'       => '',
					],
				],
		],
			...
			'features' =>
				[
					[
						...
						'price'       => '79EUR / 89USD',
						'url'         => matomo_decorate_goal_url( 'https://plugins.matomo.org/FormAnalytics?pk_campaign=WP&pk_source=Plugin' ),
						'image'       => '',
					],
					[
						...
						'price'       => '79EUR / 89USD',
						'url'         => matomo_decorate_goal_url( 'https://plugins.matomo.org/MediaAnalytics?pk_campaign=WP&pk_source=Plugin' ),
						'image'       => '',
					],
					[
						'name'        => 'Users Flow',
						...
						'price'       => '39EUR / 39USD',
						'url'         => matomo_decorate_goal_url( 'https://plugins.matomo.org/UsersFlow?pk_campaign=WP&pk_source=Plugin' ),
						'image'       => '',
					],
				],
		],
			...
			'features' =>
				[
					[
						...
						'price'       => '69EUR / 79USD',
						'url'         => matomo_decorate_goal_url( 'https://plugins.matomo.org/SearchEngineKeywordsPerformance?pk_campaign=WP&pk_source=Plugin' ),
						'image'       => '',
					],
					[
						'name'        => 'SEO Web Vitals',
						...
						'price'       => '39EUR / 39USD',
						'url'         => matomo_decorate_goal_url( 'https://plugins.matomo.org/SEOWebVitals?pk_campaign=WP&pk_source=Plugin' ),
						'image'       => '',
					],
				],
		],
			...
			'features' =>
				[
					[
						...
						'price'       => '79EUR / 89USD',
						'url'         => matomo_decorate_goal_url( 'https://plugins.matomo.org/AdvertisingConversionExport?pk_campaign=WP&pk_source=Plugin' ),
						'image'       => '',
					],
					[
						...
						'price'       => '39EUR / 39USD',
						'url'         => matomo_decorate_goal_url( 'https://plugins.matomo.org/MultiChannelConversionAttribution?pk_campaign=WP&pk_source=Plugin' ),
						'image'       => '',
					],
				],
		],
			...
			'features' =>
				[
					[
						...
						'price'       => '89EUR / 99USD',
						'url'         => matomo_decorate_goal_url( 'https://plugins.matomo.org/Funnels?pk_campaign=WP&pk_source=Plugin' ),
						'image'       => '',
					],
					[
						'name'        => 'Cohorts',
						...
						'price'       => '49EUR / 59USD',
						'url'         => matomo_decorate_goal_url( 'https://plugins.matomo.org/Cohorts?pk_campaign=WP&pk_source=Plugin' ),
						'image'       => '',
					],
					[
						'name'        => 'Crash Analytics',
