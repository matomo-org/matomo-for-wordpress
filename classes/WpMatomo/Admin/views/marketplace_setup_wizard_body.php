	...
	<?php if ( $user_can_upload_plugins && ! $is_plugin_installed ) { ?>
		...
		<div class="wizard-steps">
			<div class="step">
				...
				<a
					class="button-primary download-plugin"
					rel="noreferrer noopener"
					target="_blank"
					href="<?php echo esc_attr( matomo_decorate_goal_url( 'https://builds.matomo.org/matomo-marketplace-for-wordpress-latest.zip' ) ); ?>"
				>
