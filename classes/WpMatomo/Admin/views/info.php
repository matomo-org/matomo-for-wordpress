...
<div class="wrap">
	...
	<p>
		...
		<?php
		echo sprintf(
			'Matomo will always cost you nothing to use, but that if you\'d like to support Matomo in a more meaningful way, take a look at our %1$spremium plugins%2$s.',
