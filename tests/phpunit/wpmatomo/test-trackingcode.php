...
class TrackingCodeTest extends MatomoUnit_TestCase {
	...
	public function test_add_feed_tracking() {
		...
		$this->assertStringStartsWith( '<p>foobarbaz</p><img src="//example.org/index.php?rest_route=/matomo/v1/hit/?idsite=23&amp;rec=1&amp;url=https%3A%2F%2Fexample.org%2F%3Fp%3D' . $post->ID . '&amp;action_name=hello-world&amp;urlref=http%3A%2F%2Fexample.org', $url );
