...
class TrackingCodeTest extends MatomoUnit_TestCase {
	...
	public function test_add_feed_tracking() {
		...
		$this->assertStringStartsWith( '<p>foobarbaz</p><img src="http://example.org/index.php?rest_route=/matomo/v1/hit/?idsite=23&amp;rec=1&amp;url=http%3A%2F%2Fexample.org%2F%3Fp%3D7&amp;action_name=hello-world&amp;urlref=http%3A%2F%2Fexample.org%2Ffeed', $url );
		$this->assertStringEndsWith( '%2F" style="border:0;width:0;height:0" width="0" height="0" alt="" />', $url );
	}
