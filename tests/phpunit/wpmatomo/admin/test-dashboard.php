...
class AdminDashboardTest extends MatomoAnalytics_TestCase {
	...
	public function test_get_widgets_toggle_widget() {
        ...
        $this->assertSame(array(
            ['unique_id' => 'VisitsSummary_get', 'date' => 'today']
        ...
        $this->assertSame(array(
            ['unique_id' => 'VisitsSummary_get', 'date' => 'today'],
            ['unique_id' => 'VisitsSummary_get', 'date' => 'yesterday'],
            ['unique_id' => 'foobar', 'date' => 'yesterday']
        ), $this->dashboard->get_widgets());
	}
    ...
    {
        return array(
            [true, Renderer::CUSTOM_UNIQUE_ID_VISITS_OVER_TIME, Dates::TODAY],
            [true, Renderer::CUSTOM_UNIQUE_ID_VISITS_OVER_TIME, Dates::LAST_WEEK],
            [false, Renderer::CUSTOM_UNIQUE_ID_VISITS_OVER_TIME, 'foobar'],

            [true, self::EXAMPLE_ID, Dates::TODAY],
            [true, 'DevicesDetection_getBrowsers', Dates::LAST_WEEK],
            [false, 'foobar_baz', Dates::LAST_WEEK],
        );
    }
